      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center mb-4">
            ...
            <span className="ml-3 text-2xl font-bold text-white">AutoResume AI</span>
          </div>
          <p className="text-white/80">Create your account and start building professional resumes today.</p>
        </div>
